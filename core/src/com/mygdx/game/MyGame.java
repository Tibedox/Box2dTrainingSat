...
public class MyGame extends Game {
	...
	public void create () {
		...
		for(int i=0; i<3; i++)
			ball.add(new DynamicBodyBall(world, 8+ MathUtils.random(-0.1f, 0.1f), 10+i*2, 0.4f));
		gantely = new Gantely(world, ball.get(0).body, ball.get(1).body);
		g2 = new Gantely(world, ball.get(1).body, ball.get(2).body);
	}
